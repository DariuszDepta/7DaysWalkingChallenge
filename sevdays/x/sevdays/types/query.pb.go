...
func (*QueryParamsRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_12c55d8cff2f7d73, []int{0}
}
...
func (*QueryParamsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_12c55d8cff2f7d73, []int{1}
}
...
func init() {
	proto.RegisterType((*QueryParamsRequest)(nil), "sevdays.sevdays.QueryParamsRequest")
	proto.RegisterType((*QueryParamsResponse)(nil), "sevdays.sevdays.QueryParamsResponse")
}

func init() { proto.RegisterFile("sevdays/sevdays/query.proto", fileDescriptor_12c55d8cff2f7d73) }

var fileDescriptor_12c55d8cff2f7d73 = []byte{
	// 292 bytes of a gzipped FileDescriptorProto
	0x1f, 0x8b, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0xff, 0xe2, 0x92, 0x2e, 0x4e, 0x2d, 0x4b,
	0x49, 0xac, 0x2c, 0xd6, 0x87, 0xd1, 0x85, 0xa5, 0xa9, 0x45, 0x95, 0x7a, 0x05, 0x45, 0xf9, 0x25,
	...
	0x9c, 0xc4, 0x06, 0x0e, 0x21, 0x63, 0x40, 0x00, 0x00, 0x00, 0xff, 0xff, 0x4e, 0x0c, 0xb3, 0x65,
	0xe2, 0x01, 0x00, 0x00,
}
...
func (c *queryClient) Params(ctx context.Context, in *QueryParamsRequest, opts ...grpc.CallOption) (*QueryParamsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/sevdays.sevdays.Query/Params", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_Params_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/sevdays.sevdays.Query/Params",
	}
...
var _Query_serviceDesc = grpc.ServiceDesc{
	ServiceName: "sevdays.sevdays.Query",
	...
	Metadata: "sevdays/sevdays/query.proto",
}
